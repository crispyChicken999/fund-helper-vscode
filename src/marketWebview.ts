...
export class MarketWebview {
  ...
  private _getHtml(): string {
    ...
    return [
      ...
      '.market-stat { display: flex; align-items: center; gap: 12px; flex-wrap: wrap; font-size: .85em; padding: 12px; background: var(--vscode-editorWidget-background); border: 1px solid var(--vscode-panel-border); border-radius: 8px; }',
      '.stat-item { display: flex; align-items: center; gap: 4px; flex: 0 1 auto; }',
