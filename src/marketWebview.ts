...
export class MarketWebview {
  ...
  private _getHtml(): string {
    ...
    return [
      ...
      '.refresh-btn { padding: 4px 12px; background: var(--vscode-button-secondaryBackground); color: var(--vscode-button-secondaryForeground); border: 1px solid var(--vscode-panel-border); border-radius: 4px; cursor: pointer; font-size: .82em; font-family: inherit; transition: background .2s; }',
      '.refresh-btn:hover { background: var(--vscode-button-secondaryHoverBackground); }',
      '.tabs { display: flex; gap: 2px; border-bottom: 2px solid var(--vscode-panel-border); }',
      '.tab-btn { padding: 7px 16px; background: transparent; border: none; border-bottom: 3px solid transparent; color: var(--vscode-descriptionForeground); cursor: pointer; font-size: .88rem; font-family: inherit; transition: all .2s; margin-bottom: -2px; border-radius: 4px 4px 0 0; }',
      '.tab-btn:hover { color: var(--vscode-editor-foreground); background: var(--vscode-list-hoverBackground); }',
      '.tab-btn.active { color: var(--vscode-editor-foreground); border-bottom-color: var(--vscode-focusBorder); font-weight: 600; }',
