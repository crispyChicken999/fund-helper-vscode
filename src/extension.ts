...
import { FundConfig, FundInfo, calcHoldingAmount } from "./fundModel";
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand("fund-helper.analyzeFunds", () => analyzeFunds(context)),
...
// AI分析功能
async function analyzeFunds(context: vscode.ExtensionContext) {
  const fundList = treeDataProvider.fundDataList;
    ...
    <body>
                ...
                <div class="advanced-settings">
                    ...
                    <div id="advancedSettings" style="display: none;">
                        <div class="form-group">
                            ...
                            <input type="number" id="temperature" value="0.7" min="0" max="2" step="0.1" placeholder="0.7">
                            <div class="provider-info">控制AI输出的随机性，数值越高越随机</div>
                        </div>
                        
                        <div class="form-group">
                            <label for="maxTokens">最大Token数：</label>
                            <input type="number" id="maxTokens" value="2000" min="100" max="4000" placeholder="2000">
        ...
        <script>
            ...
            function updateProviderInfo() {
                ...
                // 更新默认端点
                document.getElementById('configName').placeholder = 
                    '例如：' + providerInfo.name + '-生产环境';
            }
