...
export function getScripts(): string[] {
  return [
    ...
    '        const dailyGain = calculateDailyGain(fund);',
    ...
    '      }',
    '      ',
    '      // 当日收益 - 根据市场状态和净值更新情况智能计算',
    '      let dailyGain = 0;',
    '      if (isMarketClosedNow) {',
    '        // 休市日：使用实际净值',
    '        dailyGain = (holdingAmount * navChgRt) / 100;',
    '      } else if (marketStatus.isOpen) {',
    '        // 开市中：使用估值',
    '        if (gsz > 0 && hasUpdatedData) {',
    '          dailyGain = (gsz - dwjz) * num;',
    '        } else if (gsz === 0 && gszzl !== 0) {',
    '          dailyGain = (holdingAmount * gszzl) / 100;',
    '        }',
    '      } else {',
    '        // 收盘后~开盘前：优先使用实际净值（如果已更新）',
    '        if (netValueUpdatedToday) {',
    '          dailyGain = (holdingAmount * navChgRt) / 100;',
    '        } else if (gsz > 0 && hasUpdatedData) {',
    '          dailyGain = (gsz - dwjz) * num;',
    '        } else if (gsz === 0 && gszzl !== 0) {',
    '          dailyGain = (holdingAmount * gszzl) / 100;',
    '        }',
