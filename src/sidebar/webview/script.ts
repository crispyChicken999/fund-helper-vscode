...
export function getScripts(): string[] {
  return [
    ...
    '    const estimatedDate = isMarketClosedNow ? "休市" : extractDate(fund.gztime); // 估算日期（休市时显示"休市"）',
    ...
    '      code: fund.code,',
    '      gsz: gsz.toFixed(4),',
    '      gszzl: isMarketClosedNow ? "--" : formatPercent(gszzl),',
    '      dwjz: dwjz.toFixed(4),',
    '      navChgRt: formatPercent(navChgRt),',
    '      estimatedGain: isMarketClosedNow ? "--" : formatMoney(estimatedGain),',
