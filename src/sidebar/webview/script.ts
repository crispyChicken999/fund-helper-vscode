...
export function getScripts(): string[] {
  return [
    ...
    '        </div>',
    '        <div class="tooltip-row">',
    '          <span class="tooltip-label">持有收益率：</span>',
    ...
    '━━━━━━━━━━━━━━━━',
    '持有收益：${formatMoney(parseFloat(data.holdingGain))}',
    '持有收益率：${formatPercent(parseFloat(data.holdingGainRate))}',
    '━━━━━━━━━━━━━━━━',
    ...
    '      const estimatedGain = (num * gsz * gszzl) / 100; // 估算收益',
