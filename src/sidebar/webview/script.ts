...
export function getScripts(): string[] {
  return [
    ...
    '          <span class="tooltip-value">${data.netValueDate} ${data.updateTime || ""}</span>',
    '        </div>',
    ...
    '    const updateTimeFormatted = `${data.netValueDate} ${data.updateTime || ""}`.trim();',
    '    const text = `',
    '基金名称：${data.name}',
    '基金代码：${data.code}',
    '━━━━━━━━━━━━━━━━',
    ...
    '',
    '      case "updateFundData":',
    '        console.log("[Frontend] updateFundData received");',
    '        console.log("[Frontend] message.groups:", message.groups);',
    '        console.log("[Frontend] message.fundGroups:", message.fundGroups);',
    '        if (message.groups) {',
    '          availableGroups = ["全部", ...message.groups.filter(g => g !== "全部")];',
    '          console.log("[Frontend] availableGroups updated:", availableGroups);',
    '        }',
    '        if (message.fundGroups) {',
    '          fundGroupsData = message.fundGroups;',
    '          console.log("[Frontend] fundGroupsData updated:", fundGroupsData);',
    '        }',
    '        if (groupManager && typeof groupManager.syncData === "function") {',
    '          console.log("[Frontend] Calling groupManager.syncData()");',
