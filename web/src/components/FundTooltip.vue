          ...
          <div v-if="visible" class="fund-tooltip-panel">
            <header class="fund-tooltip-head">
              <div>
                ...
                <div class="fund-tooltip-code" title="点击复制基金代码" @click="handleCodeCopy(row!.code)">{{ row?.code }}</div>
              </div>
              ...
              <section class="fund-tooltip-body" v-if="row">
                ...
                <div class="info-group">
                  ...
                  <div class="info-row">
                    ...
                    <span>{{ fmtPct(getHoldingPosition(row.holdingAmount), true, false) }}</span>
                  </div>
                </div>
                <div class="info-group">
                  <div class="info-row">
