        ...
        <section class="tooltip-body">
          ...
          <div class="info-group">
            ...
            <div class="info-row">
              ...
              <span
                ...
                <span class="negative">{{ stats.dailyDownCount }}</span></span
              >
            </div>
          </div>
          ...
          <div class="info-group">
            ...
            <div class="info-row">
              ...
              >
              <span
                ><span class="positive">{{ stats.holdingProfitCount }}</span> /
                <span class="negative">{{ stats.holdingLossCount }}</span></span
              >
            </div>
          </div>
