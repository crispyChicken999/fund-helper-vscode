...
```sh
curl -X POST 'https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b' \
...
```sh
curl -X GET 'https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b'
```
...
```sh
curl -X GET 'https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b/users'
```
...
```sh
curl -X GET 'https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b?sort=-age'
```

To read a specific record use `jsonbox.io/${BOX_ID}/${RECORD_ID}`.

```sh
curl -X GET 'https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b/5d776a25fd6d3d6cb1d45c51'
```

To query records, you have to pass the key & value as shown below.

```sh
curl -X GET 'https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b?q=name:arya%20stark'
```
...
```sh
curl -X GET 'https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b?q=name:arya%20stark,age:>13'
```
...
```
https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b?q=name:arya%20stark,age:>13,isalive:true
```
...
```sh
curl -X PUT 'https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b/5d776b75fd6d3d6cb1d45c53' \
    -H 'content-type: application/json' \
...
```sh
curl -X DELETE 'https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b/5d776b75fd6d3d6cb1d45c53'
```

- To delete based on a filter use HTTP DELETE with jsonbox.io/\${BOX_ID}?q={QUERY}

```sh
curl -X DELETE 'https://jsonbox.cloud.exo-imaging.com/demobox_6d9e326c183fde7b?q=name:arya%20stark,age:>13'
```
...
```
https://jsonbox.cloud.exo-imaging.com/_meta/demobox_6d9e326c183fde7b
```
